...
def play():
    ...
    if player[0] == 1 and player[1] == 1:
        player[0] = 11
        player[1] = 1
        print("You were dealt two Aces for a total of " + str(sum(player)) + ".")
    elif player[0] == 1:
        print("Your first card is an Ace and your second card is " + str(player[1]) + ".")
        if sum(player) == 11:
        ...
        print("Your first card is " + str(player[0]) + " and your second card is an Ace.")
        if sum(player) == 11:
            print("You have 21. BLACKJACK!")
            wallet += Decimal((wager * 3 / 2))
            playagain()
...
def first_card():
    ace = input("Would you like the Ace to be a 1 or 11? Type O or E. ")
...
def playagain():
    ...
    if replay.lower() == 'y' or replay.lower() == 'yes':
        ...
        print("Invalid entry. Please user Y or N.")
        playagain()
